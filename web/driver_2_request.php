            ...
            <div class="forms">
                <div class=" form-grids form-grids-right">
                    <div class="widget-shadow " data-example-id="basic-forms">
                        ...
                        <div class="form-body">
                            <form method="POST" action="driver_2_request.php?i=<?php echo $_GET['i'] ?>"
                                ...
                                <div class="form-group valid-form">
                                    ...
                                    <div class="col-sm-3">
                                        <input id="driver" name="driver" value="<?php echo $driver?>" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-1 ">
                                        <a href="request.php" type="button" id="cancel" class="btn btn-danger" style="width: 100%">الغاء</a>
                                    </div>
                                    <div class="col-sm-2 ">
                                        <button type="submit" id="edit" name="edit" class="btn btn-default"
                                                <?php if($status>=3) echo "disabled" ?>
                                                style="border-radius: 5px"> تعديل
                                        </button>
                                    </div>
                            </form>
                    ...
                    <div>
                        ...
                        if (isset($_POST['edit']))
                        {
                                ...
                                Request_Update($_GET['i'], $_POST["driver"], 1,"","","");
