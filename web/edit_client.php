...
{
    $id = $_GET['Id'];
    $username = $access = $fees = "";
    Create_conn();
    $result = User_Search($id, "", "", "", "");
    //Close_conn();
                            ...
                            <form method="POST" action="edit_client.php?Id=<?php echo $id ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <span class="help-block">يمكنك تغيير رمز المرور باستخدام 6 أحرف أو أكثر</span>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <input id="confirm_password" name="confirm_password" type="password"
                                               class="form-control" data-toggle="validator"
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 ">
                                        ...
                                        <span id="custom-text"> لم يتم إختيار أي صورة </span>
                                    </div>
                                </div>
                                <br>
                                <br>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="access" id="access" required="true" class="form-control">
                                            <option value="0" <?php if ($access == 0) echo "selected" ?>>عميل</option>
                                            <option value="1" <?php if ($access == 1) echo "selected" ?>>ادمن</option>
                                            <option value="2" <?php if ($access == 2) echo "selected" ?>>مشرف</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input id="fees" name="fees" type="text" value="<?php echo $fees; ?>"
                                               class="form-control">
                                    </div>
                                </div>
                                <br>
                                <div class="form-group">
                                    <div class="col-sm-1 ">
                                    <a href="users.php" type="button" id="cancel" class="btn btn-danger" style="width: 100%">الغاء</a>
                                    </div>
                                    <div class="col-sm-2 ">
                                        <button type="submit" id="edit" name="edit" class="btn btn-default" style="border-radius: 5px"> تعديل
                                        </button>
                                    </div>
                            </form>
                    ...
                    <div>
                        ...
                        if (isset($_POST['edit']))
                        {
                            ...
                            if (($_POST["password"] == $_POST["confirm_password"]))
                            {
                                ...
                                User_Update($id, $_POST["username"], $_POST["password"], $_POST["access"], $_POST["fees"],0);
                                Close_conn();
