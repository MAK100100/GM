            ...
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar"
                ...
                <div class="scrollbar scrollbar1">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-dollar-sign nav_icon"></i> الحسابات <span
                                        class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <li>
                ...
                <div class=" form-grids form-grids-right">
                    <div class="widget-shadow " data-example-id="basic-forms">
                        ...
                        <div class="form-body">
                                ...
                                <div class="row four-grids">
                                    ...
                                    <div class="col-md-6 ticket-grid">
                                        <div class="tickets">
                                            ...
                                            <div class="grid-right">
                                                <h3>Contracter<span>المتعاقد</span></h3>
                                                <p><?php echo $name; ?></p>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                            ...
                            <hr>
                            <br>
                            <form method="POST" action="payment.php?id=<?php echo $_GET['id'] ?>"
                                ...
                                <hr>
                                <p>لتأكيد العملية يرجى إدخال كلمة المرور:</p>
                                <br>
                                <div class="form-group valid-form">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-2 ">
                                        <a href="balance.php" id="cancel" class="btn btn-danger" style="width: 100%">الغاء</a>
                                    </div>
                                    <div class="col-sm-2 ">
                                        <button type="submit" id="pay" name="pay" class="btn btn-success"
                                                style="border-radius: 5px; width: 100%"> تسديد
                                        </button>
                                    </div>
                                    ...
                                    if (isset($_POST['pay']))
                                    {
                                        ...
                                        if ($balance >= $amount)
                                        {
                                            ...
                                            {
                                                transaction_insert($_SESSION['username'], $name, 0000, - ($amount), ($balance - $amount), $note);
                                                User_Update("",$name,"","","",($balance-$amount));
                                                header(sprintf("Location: %s/payment.php?id=".$_GET['id'] , $url));
                                            }
                                            else
                                                echo "يرجى التأكد من كلمة المرور الخاصة بحسابك.";
                                        }
                                        else
                                            echo "يرجى ادخال مبلغ يساوي او اقل من قيمة الرصيد.";
