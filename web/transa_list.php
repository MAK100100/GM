...
{
    $data = User_Search('', $_SESSION['username'], '', '', '', '');
    foreach ($data as $result)
    {
    ...
    $count = 0;
    $data = req_Search("", $_SESSION['username'], "", "", "3", "", "");
    foreach ($data as $result)
    {
        $count = $count + 1;
    }
            ...
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar"
                ...
                <div class="scrollbar scrollbar1">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-dollar-sign nav_icon" style="text-align: center"></i> الحسابات  <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <li>
            ...
            <div class="forms">
                <div class=" form-grids form-grids-right">
                    <div class="widget-shadow " data-example-id="basic-forms">
                        ...
                        <div class="form-body">
                            <form method="post" action="transa_list.php"
                                    ...
                                    <div class="row four-grids">
                                        <div class="col-md-6 ticket-grid">
                                            <div class="tickets">
                                                ...
                                                <div class="grid-right">
                                                    <h3>Request Count<span>عدد الطلبات</span></h3>
                                                    <p><?php echo $count; ?></p>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        ...
                                        <div class="col-md-6 ticket-grid">
                                            <div class="tickets">
                                                ...
                                                <div class="grid-right">
                                                    <h3>Balance <span>الرصيد</span></h3>
                                                    <p><?php echo $balance . " IQD"; ?></p>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group valid-form">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="req_no" name="req_no" class="form-control">
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group">
                                    <label for="supervisor" class="col-sm-1 control-label">
                                        <strong> إسم المشرف: </strong>
                                    </label>
                                    <div class="col-sm-2">
                                        <input id="supervisor" name="supervisor" class="form-control">
                                    </div>
                                    <label for="tran_type" class="col-sm-1 col-sm-offset-1 control-label">
                                        <strong> نوع الحواله: </strong>
                                    </label>
                                    <div class="col-sm-2">
                                        <select name="tran_type" id="tran_type" required="true" class="form-control">
                                            <option value="0" selected>الكل</option>
                                            <option value="1" >تسديد</option>
                                            <option value="2" >طلبات</option>
                                        </select>
                                    </div>
                                </div>
                                <hr/>
                                ...
                                {
                                    if (($_POST['source']!="")||($_POST['req_no']!="")||($_POST['supervisor']!="")||($_POST['startDate']!=""))//||($_POST['status']>-1))
                                            $data=Trans_Search("",$_POST['source'],$_POST['req_no'],$_POST['supervisor'],$_POST['startDate'],"");
                                        else
                                            goto show;
                                }
                                else
                                    show: $data = transa_list($_SESSION['username'],$_SESSION['access']);

                                Display_transa($data);
                                if(isset($_POST['export']))
                                {
                                 header(sprintf("Location: %s/export.php?type=2", $url));
                                }
                                else
                                if (isset($data))
                                {
