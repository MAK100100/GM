                ...
                <div class="forms">
                    <div class=" form-grids form-grids-right">
                        <div class="widget-shadow " data-example-id="basic-forms">
                            ...
                            <div class="form-title">
                                <h5 style="color: white"> حذف المستخدم يعني ازالة كافة المعلومات الخاصة به من قاعدة
                                    البيانات </h5>
                            </div>
                            <div class="form-body">
                                <form method="POST" action="del_client.php?Id=<?php echo $id ?>"
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-2">
                                            <input type="submit" class="btn btn-danger" style="border-radius: 5px; width: 100%" name="yes" id="yes"
                                                   onclick="show_alert();" value="تأكيد" disabled="disabled" >
                                        </div>
                                        <div class="col-sm-2">
                                            <input type="submit" class="btn btn-default"
                                                   style="border-radius: 5px; width: 100%" name="no" id="no"
                                                   value="إلغاء">
                                        </div>
                                    </div>
