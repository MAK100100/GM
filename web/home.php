...
$balance = $orders = $in_progress_order = $complete_order = 0;
if ($_SESSION['access'] >= 1) {
    ...
    $count = 0;
    $data = req_Search("", $_SESSION['username'], "", "", "", "", "");
    foreach ($data as $result) {
        $orders = $orders + 1;
        if ($result['status'] < 3)
            $in_progress_order += 1;
...
<script>
    $(function () {
        var bal = document.getElementById("hide");
        var userlist = document.getElementById("user-list");
        var x = <?php echo $_SESSION['access']?>;
        if (x == 2) {
            ...
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar"
                ...
                <div class="scrollbar scrollbar1">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="home.php" class="active"><i class="fa fa-home nav_icon"></i> الرئيسية </a>
                        </li>
                        <li id="user-list">
    ...
    <div class="sticky-header header-section ">
        <div class="header-right">
            ...
            <div class="logo">
                <a href="home.php">
                    <ul>
                        <li><img src="images/wlogo.gif" alt="" style="width: 75px"/></li>
    ...
    <div id="page-wrapper">
        <div class="main-page">
                ...
                <div class="col-md-6 ticket-grid">
                    <a href="request.php">
                        <div class="tickets">
                            ...
                            <div class="grid-right">
                                <h3>Orders<span>الطلبات</span></h3>
                                <p><?php echo $orders ?></p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-6 ticket-grid">
                    <a href="request.php">
                        <div class="tickets">
                            ...
                            <div class="grid-right">
                                <h3>Successful Orders<span>الطلبات المنجزة</span></h3>
                                <p><?php echo $complete_order ?></p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </a>
                ...
                <div class="col-md-6 ticket-grid">
                    <a href="request.php">
                        <div class="tickets">
                            ...
                            <div class="grid-right">
                                <h3>‘In progress Orders<span>طلبات قيد الانجاز</span></h3>
                                <p><?php echo $in_progress_order ?></p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </a>
            ...
            <div class="container-image">
                <a href="new_req.php">
                    <img src="images/icon-delvery.PNG" alt="" class="image">
                    <div class="overlay-image">
                        <div class="text-image"> إضافة طلب</div>
                    </div>
                </a>
            </div>
        </div>
