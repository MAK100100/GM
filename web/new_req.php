                ...
                <div class=" form-grids form-grids-right">
                    <div class="widget-shadow " data-example-id="basic-forms">
                        <div class="form-title">
                            <h4> اضافة طلب جديد : </h4>
                        </div>
                        <div class="form-body">
                            <form method="post" action="new_req.php" class="form-horizontal validation-grids widget-shadow " data-toggle="validator"
                                  novalidate="true">
                                <div class="form-group valid-form">
                                    ...
                                    <div class="col-sm-3">
                                        <input id="destination" name="destination" class="form-control"  required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input id="req_id" name="req_id"  class="form-control"  required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="input_cost" class="col-sm-2 control-label">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-2 ">
                                        <button type="submit" id="add" name="add" class="btn btn-default">اضافة</button>
                                    </div>
                                </div>
                                <div>
                                    <?php
                                         ...
                                         if (isset($_POST['add']))
                                              ...
                                              $cost = $_POST['cost'];
                                              $note = $_POST['note'];
                                              insert(date("Y-m-d"),date("G:i:s"), $_SESSION["username"],$destination, $id_req,"",$cost,$_SESSION['fees'],$note,0);
